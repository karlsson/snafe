...
pub fn get_national_compulsory_average_response(response) {
  ...
  case status {
    200 -> json.parse_bits(body, schema.api_response_decoder()) |> result.map(Ok)
    _ -> Error(Nil) |> Ok
  }
}
...
pub fn get_all_study_paths_compact_per_unit_request(
  ...
  let method = http.Get
  let path = "/v3/school-units/" <> school_unit_code <> "/compact-education-events"
  let query = [
    #("type_of_schooling", type_of_schooling),
    #("sort", sort),
    #("page", option.map(page, int.to_string)),
...
pub fn get_custodians_pre_school_class_surveys_by_school_unit_code_1_request(
  ...
  let method = http.Get
  let path = "/v3/school-units/" <> school_unit_code <> "/nestedsurveys/custodiansfsk"
  let query = []
  base |> utils.set_method(method) |> utils.append_path(path) |> utils.set_query(
    query,
  )
...
pub fn get_document_by_school_unit_code_and_type_of_schooling_request(
  ...
  let method = http.Get
  let path = "/v3/school-units/" <> school_unit_code <> "/documents/" <> type_of_schooling
  let query = []
  base |> utils.set_method(method) |> utils.append_path(path) |> utils.set_query(
    query,
  )
...
pub fn get_custodians_compulsory_school_for_disabled_unit_surveys_by_school_unit_code_request(
  ...
  let method = http.Get
  let path = "/v3/school-units/" <> school_unit_code <> "/surveys/custodiansgran"
  let query = []
  base |> utils.set_method(method) |> utils.append_path(path) |> utils.set_query(
    query,
  )
...
pub fn get_by_study_path_code_and_school_unit_code_request(
  ...
  let method = http.Get
  let path = "/v3/school-units/" <> school_unit_code <> "/education-events/" <> study_path_code
  let query = []
  base |> utils.set_method(method) |> utils.append_path(path) |> utils.set_query(
    query,
  )
...
pub fn get_custodians_compulsory_school_unit_surveys_by_school_unit_code_1_request(
  ...
  let method = http.Get
  let path = "/v3/school-units/" <> school_unit_code <> "/nestedsurveys/custodiansgr"
  let query = []
  base |> utils.set_method(method) |> utils.append_path(path) |> utils.set_query(
    query,
  )
...
pub fn get_custodians_compulsory_school_for_disabled_unit_surveys_by_school_unit_code_1_request(
  ...
  let method = http.Get
  let path = "/v3/school-units/" <> school_unit_code <> "/nestedsurveys/custodiansgran"
  let query = []
  base |> utils.set_method(method) |> utils.append_path(path) |> utils.set_query(
    query,
  )
...
pub fn get_pupils_secondary_school_unit_surveys_by_school_unit_code_1_request(
  ...
  let method = http.Get
  let path = "/v3/school-units/" <> school_unit_code <> "/nestedsurveys/pupilsgy"
  let query = []
  base |> utils.set_method(method) |> utils.append_path(path) |> utils.set_query(
    query,
  )
